# Soft Tide — Suno generation brief (male vocal)

Use this in **Suno Custom Mode** for a real sung male R&B vocal (not TTS).

## Style tags
```
HYBS style, Thai neo city-pop, soft male R&B vocals, breezy soul, groovy bass, warm electric guitar licks, chill disco pocket, modern indie R&B, smooth falsetto adlibs, intimate close mic, English lyrics, compact single under 2 minutes
```

## Title
Soft Tide

## Lyrics (paste exactly)
```
[Intro]
...
## Extra prompt notes (optional)
```
Male lead vocal like HYBS / soft Thai indie R&B, natural human singing, not robotic, not speech-to-song, warm chest voice with light falsetto on chorus peaks, ~96 BPM, short song ~90 seconds
```
